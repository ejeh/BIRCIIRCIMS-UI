...
(function($){
	...
	(function(){
		...
		$('.product_brands2 a.animate_fade').waypointSynchronise({
			container : '.product_brands2',
			delay : 200,
			offset : 830,
			classN : "animate_sj_finished animate_fade_finished"
		});
...
$('#shopping_button').on('mouseenter',function(){
  ...
  $(this).css('z-index','189');
	...
	(function(){
		if($('.product_brands').length){
		 	var pb = $(".product_brands").owlCarousel({
		 		itemsCustom : $('.product_brands').hasClass('with_sidebar') ? [[1199,4],[992,4],[768,4],[480,3],[300,2]] : [[1199,6],[992,5],[768,4],[480,3],[300,2]],
		 		autoPlay : true,
		 		stopOnHover : true,
		 		slideSpeed : 600,
		 		addClassActive : true
	...
	(function(){
		if($('.product_brands2').length){
		 	var pb = $(".product_brands2").owlCarousel({
		 		itemsCustom : $('.product_brands2').hasClass('with_sidebar') ? [[1199,3],[992,2],[768,2],[480,3],[300,2]] : [[1199,3],[992,2],[768,2],[480,3],[300,2]],
		 		autoPlay : true,
		 		stopOnHover : true,
		 		slideSpeed : 600,
		 		addClassActive : true
